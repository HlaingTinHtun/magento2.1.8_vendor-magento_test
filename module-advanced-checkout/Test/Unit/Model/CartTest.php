...
/**
 * Test for \Magento\AdvancedCheckout\Model\Cart
 * 
...
class CartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $cartMock = $this->getMock(\Magento\Checkout\Model\Cart::class, [], [], '', false);
        $messageFactoryMock = $this->getMock(\Magento\Framework\Message\Factory::class, [], [], '', false);
        $eventManagerMock = $this->getMock(\Magento\Framework\Event\ManagerInterface::class);
        $this->helperMock = $this->getMock(\Magento\AdvancedCheckout\Helper\Data::class, [], [], '', false);
        $wishListFactoryMock = $this->getMock(
        ...
        $this->quoteMock = $this->getMock(\Magento\Quote\Model\Quote::class, ['getStore', '__wakeup'], [], '', false);
        $this->quoteRepositoryMock = $this->getMock(\Magento\Quote\Api\CartRepositoryInterface::class);
        $this->storeManagerMock = $this->getMock(\Magento\Store\Model\StoreManagerInterface::class);
        $this->localeFormatMock = $this->getMock(\Magento\Framework\Locale\FormatInterface::class);
        $messageManagerMock = $this->getMock(\Magento\Framework\Message\ManagerInterface::class);
        $customerSessionMock = $this->getMock(\Magento\Customer\Model\Session::class, [], [], '', false);
        ...
        $cartConfigMock = $this->getMock(\Magento\Catalog\Model\Product\CartConfiguration::class, [], [], '', false);
    ...
    {
        $storeMock = $this->getMock(\Magento\Store\Model\Store::class, ['getId', 'getWebsiteId'], [], '', false);
