...
abstract class AbstractPdf extends \Magento\Framework\DataObject
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($putOrderId) {
            $page->drawText(__('Order # ') . $order->getRealOrderId(), 35, $top -= 35, 'UTF-8');
        }
        $page->drawText(
            __('Order Date: ') .
        ...
        //custom add for delivery information...
        $_objectManager = \Magento\Framework\App\ObjectManager::getInstance();
$_deliveryInformation = $_objectManager->create('Magedelight\ScheduleShipping\Helper\Deliveryinfo');
$this->y = $_deliveryInformation->getDeliveryInformation($this->y,$page, $order);
//end custom add for delivery information
    }
