...
/**
 * Migration abstract command test.
 * 
...
class AbstractCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getDefinitions(array $names)
    {
        ...
        foreach ($names as $name) {
            $definition = $this->getMock(InputOption::class, [], [], '', false, false);
    ...
    {
        $select = $this->getMock(Select::class, [], [], '', false, false);
        $stmt = $this->getMock(\Zend_Db_Statement_Pdo::class, [], [], '', false, false);
