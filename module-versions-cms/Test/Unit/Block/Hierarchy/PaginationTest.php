...
/**
 * Tests Magento\VersionCms\Block\Hierarchy\PaginationTest Class.
 */
class PaginationTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->nodeFactoryMock = $this->getMock(
    ...
    protected function getParentNodeChildren()
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $node = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
