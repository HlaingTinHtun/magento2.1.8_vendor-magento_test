...
/**
 * Tests Magento\VersionsCms\Block\Hierarchy\Head Class.
 */
class HeadTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->cmsHierarchy = $this->getMock(\Magento\VersionsCms\Helper\Hierarchy::class, [], [], '', false);

        $this->chapter = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
        $this->section = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
        $this->next = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
        $this->prev = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
        $this->first = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);

        $this->pageConfig = $this->getMock(\Magento\Framework\View\Page\Config::class, [], [], '', false);
        $this->node = $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
        $this->layout = $this->getMock(\Magento\Framework\View\LayoutInterface::class, [], [], '', false);
