...
/**
 * Test Magento\VersionsCms\Test\Unit\Block\Cms\Page Class.
...
class PageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test that page doesn't contains breadcrumbs if they are not set.
     */
    public function testAddBreadcrumbsWithDisabledBreadcrumbs()
    {
    ...
    /**
     * Test that page doesn't contains breadcrumbs if breadcrumbs block doesn't exist.
     */
    public function testAddBreadcrumbsWithNoBreadcrumbsBlock()
    {
        $this->scopeConfigMock->expects($this->once())
            ->method('getValue')
            ->with('web/default/show_cms_breadcrumbs', ScopeInterface::SCOPE_STORE)
    ...
    /**
     * Test that homepage doesn't contains breadcrumbs.
     */
    ...
    /**
     * Test that page contains breadcrumbs, if it's not a cms page.
     */
    public function testAddBreadcrumbsWithPageIdentifiersNotEqualsCmsPages()
    {
        ...
        $this->scopeConfigMock->expects($this->exactly(3))
            ...
            ->willReturnMap([
                ['web/default/show_cms_breadcrumbs', ScopeInterface::SCOPE_STORE, null, true],
                ['web/default/cms_home_page', ScopeInterface::SCOPE_STORE, null, null],
    ...
    /**
     * Test that page contains breadcrumbs without current node.
     */
    public function testAddBreadcrumbsWithNoCurrentNode()
    {
        ...
        $this->scopeConfigMock->expects($this->exactly(3))
            ...
            ->willReturnMap([
                ['web/default/show_cms_breadcrumbs', ScopeInterface::SCOPE_STORE, null, true],
                ['web/default/cms_home_page', ScopeInterface::SCOPE_STORE, null, null],
                ['web/default/cms_no_route', ScopeInterface::SCOPE_STORE, null, null],
            ]);
