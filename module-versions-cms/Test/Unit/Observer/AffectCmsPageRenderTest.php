...
/**
 * Tests Magento\VersionsCms\Observer\AffectCnsPageRender Class.
 * 
...
class AffectCmsPageRenderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cmsHierarchyMock = $this->getMock(\Magento\VersionsCms\Helper\Hierarchy::class, [], [], '', false);
        ...
        $this->updateMock = $this->getMock(\Magento\Framework\View\Layout\ProcessorInterface::class);
    ...
    {
        return $this->getMock(\Magento\VersionsCms\Model\Hierarchy\Node::class, [], [], '', false);
    }
}
