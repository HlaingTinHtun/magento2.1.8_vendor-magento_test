 ...
 */
class AddCmsToTopmenuItemsTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * Test CMS Hierarchy menu item added to top menu.
     *
    ...
    public function testExecute(
        ...
        $this->hierarchyNodeFactoryMock->expects($this->exactly(2))
            ->method('create')
            ->willReturnMap([
